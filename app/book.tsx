...
export default function Book() {
    ...
    const times = ["07:00", "07:30", "08:00", "08:30", "09:00", "09:30", "10:00", "11:00", "11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30", "18:00", "18:30", "19:00"]
            ...
            <Center>
                ...
                <Box bg="gray.50" w="100%" h={450} p={4}>
                    ...
                    <Box maxW="200px" mx="auto" mt={8}>
                        <SimpleGrid columns={1} spacing={1}>
                        <Button type="submit" leftIcon={<CalendarIcon />} loadingText='Submitting...' colorScheme='blue'variant='outline' size='lg'>
                            Book now
                        </Button>
                        </SimpleGrid>
                    </Box>
